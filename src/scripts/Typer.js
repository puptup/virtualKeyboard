...
export default class Typer extends Elem {
  ...
  // друг, это заглушки, они нужны из-за того, что этот тест должен
  // поддерживать такой же интерфейс как и у класса textarea.
  // иначе при нажатии на backspace будет выбиваться ошибка
